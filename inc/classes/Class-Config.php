	...
	final class Etrain{
		...
		private function enqueue(){
			...
			$scripts = array(
				'style' => array(
					array(
						'handler'		=> 'etrain-theme-google-font',
					...
					array(
						'handler'		=> 'etrain-theme-owl-carousel',
						'file' 			=> $cssPath.'owl.carousel.min.css',
						'dependency' 	=> array(),
						'version' 		=> '1.0',
					),
					array(
						'handler'		=> 'etrain-theme-font-awesome',
						'file' 			=> $cssPath.'font-awesome.min.css',
						'dependency' 	=> array(),
						'version' 		=> '7.3.1-1',
					),
					array(
						'handler'		=> 'etrain-theme-themify',
					...
					array(
						'handler'		=> 'etrain-theme-slick-css',
						'file' 			=> $cssPath.'slick.css',
						'dependency' 	=> array(),
						'version' 		=> '1.0',
					),
					array(
						'handler'		=> 'etrain-theme-default-css',
					...
					array(
						'handler'		=> 'etrain-theme-etrain-style',
				...
				'scripts' => array(
					...
					array(
						'handler'		=> 'etrain-theme-magnific-popup-js',
					...
					array(
						'handler'		=> 'etrain-theme-swiper-min-js',
					...
					array(
						'handler'		=> 'etrain-theme-instagram-feed-js',
					...
					array(
						'handler'		=> 'etrain-theme-owl-carousel-js',
					...
					array(
						'handler'		=> 'etrain-theme-jquery.nice-select-js',
					...
					array(
						'handler'		=> 'etrain-theme-jquery-counterup-js',
					...
					array(
						'handler'		=> 'etrain-theme-waypoints-min-js',
					...
					array(
						'handler'		=> 'etrain-theme-slick-min-js',
