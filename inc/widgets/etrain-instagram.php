...
----------------------------------------*/
class etrain_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('etrain_instagram_photo',esc_html__('[ Etrain ] Intagram Photo','etrain'),array(
			'description' => esc_html__('Etrain Instagram Photo Widget','etrain'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'etrain');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'etrain'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'etrain'); ?></label>
...
if(!function_exists('etrain_instagram_widgets')):
	function etrain_instagram_widgets(){
		register_widget('etrain_instagram_photo');
	}
	add_action('widgets_init','etrain_instagram_widgets');
endif;
