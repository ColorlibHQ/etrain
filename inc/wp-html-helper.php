...
// image default alt
if( !function_exists( 'etrain_img_default_alt' ) ){
	function etrain_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'etrain_img_tag' ) ){
	function etrain_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = etrain_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'etrain_anchor_tag' ) ){
	function etrain_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'etrain_heading_tag' ) ){
	function etrain_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'etrain_paragraph_tag' ) ){
	function etrain_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'etrain_other_tag' ) ){
	function etrain_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'etrain_button_element ' ) ){
	function etrain_button_element( array $args ){
