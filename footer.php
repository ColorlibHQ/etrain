 ...
 */
    ...
    $copyRight = !empty( etrain_opt( 'etrain_footer_copyright_text' ) ) ? etrain_opt( 'etrain_footer_copyright_text' ) : $copyText;
    $footer_class = etrain_opt( 'etrain_footer_widget_toggle' ) == 1 ? 'footer-area' : 'no_widget';
    ...
    <footer class="footer-area">
        <?php
            if( etrain_opt( 'etrain_footer_widget_toggle' ) == 1 ) {
        ?>
        <div class="container">
